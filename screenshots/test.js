...
(async () => {
  ...
  await page.goto('https://8080-dcdbdadaccecefaefcfaebdcfeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-dcdbdadaccecefaefcfaebdcfeecdcaceefaffcabd.ide.exam.ly');
