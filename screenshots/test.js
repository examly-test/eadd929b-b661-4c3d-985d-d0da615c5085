...
(async () => {
  ...
  await page.goto('https://8080-aacdadadbaefcfaebdcfeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-aacdadadbaefcfaebdcfeecdcaceefaffcabd.ide.exam.ly');
